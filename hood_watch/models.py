...
class Neighbourhood(models.Model):
    ...
    def get_hood():
        ...
        return hood
    @classmethod
    def search_by_business(cls,query):
        result = cls.objects.filter(business__name__icontains=query)
        return result
...
class Business(models.Model):
    ...
    def __str__(self):
        return self.name
    @classmethod
    def search_by_hood(cls,query):
        result = cls.objects.filter(hood__name__icontains=query)
        return result
    # def create_business():
    #     self.save()
    # def delete_business():
